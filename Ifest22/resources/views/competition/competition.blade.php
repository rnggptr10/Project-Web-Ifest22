    ...
    <div class="container" style="padding: 0; ">
        <div class="row">
            <div class="col" style="padding: 20px 0 20px 0;">
                ...
                <div class="row" align="center" id="competitionPrizes" style="padding-top: 30px;padding-bottom: 30px;">
            ...
            <div class="row justify-content-center align-items-center" align="center" id="competitionButton" style="padding-top: 30px;padding-bottom: 30px;">
                @yield('competition_button')
            </div>

            <div class="row justify-content-center align-items-center" align="center" id="competitionFAQ" style="padding-top: 30px;padding-bottom: 30px;">
