...
@section('form')
<form action="{{ route('dac.resubmit.payment') }}" method="post" enctype="multipart/form-data">
    @method('patch')
    @csrf
    <div id="regist-section-1">
        <div class="row">
            <h6 class="regist-text-subhead">Re-Submit Payment Proof</h6>
        </div>
        <div class="row">
            <div class="col">
                ...
                <div class="row justify-content-center align-items-center" align="center" id="registCompButton2" style="padding:30px 0 30px 0; text-align:center;">
                    <div class="col">
                        <button class="btn btn-outline-primary ifest-btn-outline-primary-dark-bg mt-3 mt-sm-0 fw-bold text-center" style="height:44px; width:128px;"><a class="ifest-btn-primary-dark-bg-text" href="{{ route('profile.ticketDetailsDac') }}">{{ __('< Back') }}</a></button>
                    </div>
                    <div class="col">
