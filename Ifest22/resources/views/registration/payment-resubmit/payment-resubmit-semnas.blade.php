...
@section('form')
<form action="{{ route('semnas.resubmit.payment') }}" method="post" enctype="multipart/form-data">
    @method('patch')
    @csrf
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="row justify-content-center align-items-center" align="center" id="registCompButton2" style="padding:30px 0 30px 0; text-align:center;">
                    <div class="col">
                        <button class="btn btn-outline-primary ifest-btn-outline-primary-dark-bg mt-3 mt-sm-0 fw-bold text-center" style="height:44px; width:128px;"><a class="ifest-btn-primary-dark-bg-text" href="{{ route('profile') }}">{{ __('< Back') }}</a></button>
                    </div>
                    <div class="col">
