...
<!-- PAGE 1 -->
<form method="post" action="{{ route('dac.registration') }}" enctype="multipart/form-data">
    @method('patch')
    @csrf
    <div id="regist-section-1">
            ...
            <div class="col">
                ...
                <div class="row">
                    <div class="col-10 text-left" style="padding:0">
                        <div class="row mb-2">
                            <div class="col">
                                <input id="team_leader" name="team_leader" type="text" class="form-control @error('team_leader') is-invalid @enderror ifest-regist-form text-center" value="{{ old('team_leader') }}" required autocomplete="team_leader" autofocus placeholder="Insert Name" placeholder="Insert Name">
                                @error('team_leader')
                                <div class="alert alert-danger mt-1 d-flex align-items-center" role="alert" style="width: 100%;
                            max-width: 333px; margin: 0 auto">
                                    <span class="iconify me-1" data-icon="akar-icons:circle-alert" data-inline="false" style="color: #842029;"></span>
                    ...
                    <div class="col-2">
                        <div class="row mb-2">
                            <div class="col">
                                ...
                                <input type="file" id="team_member_2_id_card" name="team_member_2_id_card" accept=".jpg, .png, .jpeg, .jfif" style="color:transparent" hidden required>
                                @error('id_card')
                                <div class="alert alert-danger mt-1 d-flex align-items-center" role="alert" style="width: 100%;
                            max-width: 333px; margin: 0 auto">
                                    <span class="iconify me-1" data-icon="akar-icons:circle-alert" data-inline="false" style="color: #842029;"></span>
        ...
        <!-- Add 1 Member -->
        <!-- 1 -->
        <div id="addmemberDAC1" class="row-addmember mb-2 align-items-center">
            <div class="col">
                <div class="row" align="left">
                ...
                <div class="row">
                    <div class="col-10 text-left" style="padding:0">
                        <div class="row mb-2">
                            <div class="col">
                                <input id="team_member_3" name="team_member_3" type="text" class="form-control @error('team_member_3') is-invalid @enderror ifest-regist-form text-center" name="team_leader" value="{{ old('team_member_3') }}" autocomplete="team_member_3" autofocus placeholder="Insert Name">
                                @error('team_member_3')
                                <div class="alert alert-danger mt-1 d-flex align-items-center" role="alert" style="width: 100%;
                            max-width: 333px; margin: 0 auto">
                                    <span class="iconify me-1" data-icon="akar-icons:circle-alert" data-inline="false" style="color: #842029;"></span>
                    ...
                    <div class="col-2">
                        <div class="row mb-2">
                            <div class="col">
                                ...
                                <input type="file" id="team_member_3_id_card" name="team_member_3_id_card" accept=".jpg, .png, .jpeg, .jfif" style="color:transparent" hidden>
                                @error('id_card')
                                <div class="alert alert-danger mt-1 d-flex align-items-center" role="alert" style="width: 100%;
                                max-width: 333px; margin: 0 auto">
                                    <span class="iconify me-1" data-icon="akar-icons:circle-alert" data-inline="false" style="color: #842029;"></span>
