            ...
            <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        ...
                        <!-- <div class="row mb-2">
                            <div class="col">
                                <input type="file" id="id_card" name="id_card" accept=".jpg, .png, .jpeg, .jfif" value="+ ID Card" style="color:transparent">
                                @error('id_card')
                                <div class="alert alert-danger mt-1 d-flex align-items-center" role="alert" style="width: 100%;
                            max-width: 333px; margin: 0 auto">
                                    <span class="iconify me-1" data-icon="akar-icons:circle-alert" data-inline="false" style="color: #842029;"></span>
                    ...
                    <div class="col-2">
                        <div class="row mb-2">
                            <div class="col">
                                ...
                                <input type="file" id="team_member_4_id_card" name="team_member_4_id_card" accept=".jpg, .png, .jpeg, .jfif" style="color:transparent" hidden>
