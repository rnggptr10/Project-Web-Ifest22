...
@section('competition_webtitle', 'INTENTION Proposal')

@section('competition_title', 'Innovative Technology Competition (INTENTION) - Proposal')
...
<div id="regist-section-1">
    <div class="row mb-2">
        <label for="team_name" class="placeholder regist-form-text" style="padding:0">{{ __('Proposal Link') }}</label>
        <input id="team_name" type="text" class="form-control @error('team_name') is-invalid @enderror ifest-regist-form text-center" name="team_name" value="{{ old('team_name') }}" required autocomplete="team_name" autofocus placeholder="Insert Proposal Link">
        @error('team_name')
